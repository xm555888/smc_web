        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            const { customAppGetInitialProps, namedExports, isNextImageImported, hasSsrAmpPages, hasNonStaticErrorPage } = await staticCheckSpan.traceAsyncFn(async ()=>{
                ...
                if (hadUnsupportedValue) {
                    Log.error(`Invalid config value exports detected, these can cause unexpected behavior from the configs not being applied. Please fix them to continue`);
                    process.exit(1);
                }
            ...
            if (hasInstrumentationHook) {
                ...
                if (!process.env.TURBOPACK && (edgeRuntimeAppCount || edgeRuntimePagesCount)) {
                    ...
                    const exportConfig = {
                        ...
                        exportPathMap: (defaultMap)=>{
                            ...
                            staticPaths.forEach((routes, originalAppPath)=>{
                                ...
                                const isRoutePPREnabled = appConfig ? checkIsRoutePPREnabled(config.experimental.ppr, appConfig) : undefined;
                                routes.forEach((route)=>{
                            ...
                            for (const route of dynamicRoutes){
                                ...
                                if (!isAppRouteHandler && (metadata == null ? void 0 : metadata.segmentPaths)) {
                                    ...
                                    for (const segmentPath of metadata.segmentPaths){
                                        const result = buildPrefetchSegmentDataRoute(route.pathname, segmentPath);
                                ...
                                const fallbackMode = route.fallbackMode ?? FallbackMode.NOT_FOUND;
